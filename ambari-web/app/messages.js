...
Em.I18n.translations = {
  ...
  'app.aboutAmbari.licensed': 'Powered by Apache Ambari & HDP  Licensed',
  ...
  'login.error.bad.credentials':'登录失败，用户名或密码错误！',
  'login.error.disabled':'登录失败，用户名或密码错误！',
  'login.error.bad.connection':'无法连接Ambari服务器。确认Ambari服务器是否开启。',
