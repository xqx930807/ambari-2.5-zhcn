...
import sys
sys.path.append("/usr/lib/python2.7/dist-packages/") # this file can be run with python2.7 that why we need this
...
class BootstrapDefault(Bootstrap):
  ambari_commons="/usr/lib/python2.7/dist-packages/ambari_commons"
