...
import sys
sys.path.append("/usr/lib/python2.7/site-packages/") # this file can be run with python2.7 that why we need this
...
class BootstrapDefault(Bootstrap):
  ambari_commons="/usr/lib/python2.7/site-packages/ambari_commons"
