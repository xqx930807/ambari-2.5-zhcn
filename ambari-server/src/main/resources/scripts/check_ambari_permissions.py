...
directories_to_check = ["/etc/ambari-server/conf", "/usr/lib/ambari-server", "/usr/lib/python2.7/dist-packages/ambari_server",
...
files_to_check = ["/etc/ambari-server/conf/", "/etc/init/ambari-server.conf", "/etc/init.d/ambari-server",
                  "/usr/lib/ambari-server", "/usr/lib/python2.7/dist-packages/ambari_server", "/usr/sbin/ambari_server_main.py",
