...
| bootstrap.script | The location and name of the Python script used to bootstrap new Ambari Agent hosts. |`/usr/lib/python2.7/site-packages/ambari_server/bootstrap.py` | 
...
| bootstrap.setup_agent.script | The location and name of the Python script executed on the Ambari Agent host during the bootstrap process. |`/usr/lib/python2.7/site-packages/ambari_server/setupAgent.py` | 
